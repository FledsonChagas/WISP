    ...
    <h1 class="ui-title" role="heading" aria-level="1">
        <a class="ui-link">
         ...
         <div data-role="content">
            ...
            <ol>
                <li>Conexão Wi-Fi: A conexão é estabelecida utilizando a biblioteca wifimgr, que gerencia a conexão Wi-Fi do dispositivo. O dispositivo é gera um AP com o nome WispSetup para configuração a senha padrão é 123456789, o IP padrão para acesso ao WispSetup é 192.168.4.1</li>
